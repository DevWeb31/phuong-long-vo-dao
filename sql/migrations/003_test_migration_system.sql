-- Migration 003: test migration system
-- Date: 2025-09-24
...
INSERT INTO public.migrations (migration_name) VALUES ('003_test_migration_system') ON CONFLICT (migration_name) DO NOTHING;